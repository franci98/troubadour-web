            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                        <h2 class="font-weight-bolder mb-0">@lang('messages.super_admin_index_title')</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('messages.super_admin_index_stats_games')</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('messages.super_admin_index_stats_users')</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $stats['users_count'] }}
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('messages.super_admin_index_stats_schools')</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $stats['schools_count'] }}
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('messages.super_admin_index_stats_classrooms')</p>
                                <h5 class="font-weight-bolder mb-0">
    ...
    <div class="row mt-4">
        <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <h6 class="ms-2 mb-4 mb-0"> @lang('messages.super_admin_index_chart_games_per_day') </h6>
                                ...
                                <script>
                                    ...
                                    var myChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '@lang('messages.super_admin_index_chart_games_per_day')',
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>@lang('messages.super_admin_index_chart_users_per_day')</h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
