...
use App\Models\InverseRhythmExercise;
use Illuminate\Support\Facades\DB;

class InverseRhythmExerciseGenerator
{

    public static function generateForLevel($level, Exercise $exercise) : InverseRhythmExercise {
    ...
    public static function generateForGuessLevel($level, Exercise $exercise) : InverseRhythmExercise {
    ...
    public static function generateForTapLevel($level, Exercise $exercise) : InverseRhythmExercise {
    ...
    private static function saveExercise($ex, &$bars) : InverseRhythmExercise {

        $ex = InverseRhythmExercise::query()->create($ex);
