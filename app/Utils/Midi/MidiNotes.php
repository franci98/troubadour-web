...
class MidiNotes
{
    ...
    public function generateInverseRhythmExerciseSound($exId, $baseFilePath, $info)
    {

        $data = InverseRhythmExercise::query()->find($exId);
        ...
        InverseRhythmExercise::query()->where('id', $exId)->update(['mp3_generated' => 1]);
