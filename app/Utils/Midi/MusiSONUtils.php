...
class MusiSONUtils {
    ...
    public static function toDurations($notes){
        ...
        foreach ($notes as $note) {
            $notesEncoded[] = (object) $note;
        }
    
        $v = [];
        $v = static::_step_durations_from_notes($notesEncoded);
        $v = static::_step_dots($notesEncoded, $v);
        $v = static::_step_tuplets($notesEncoded, $v);
        $v = static::_step_ties($notesEncoded, $v);
