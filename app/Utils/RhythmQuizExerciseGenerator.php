...
use App\Models\RhythmQuizExercise;
use Illuminate\Support\Facades\DB;

class RhythmQuizExerciseGenerator extends ExerciseGenerator
{

    public function generateExercise(): RhythmQuizExercise
    {
        // error_log('generateForGuessLevel');
        $exercise = $this->exercise;
        $level = $this->exercise->game->difficulty->parameters;
    ...
    private static function saveExercise($ex, &$bars) : RhythmQuizExercise {

        $ex = RhythmQuizExercise::query()->create($ex);
        ...
        DB::insert("INSERT INTO rhythm_quiz_exercise_bars (rhythm_quiz_exercise_id, rhythm_bar_id, seq) VALUES $tuplets");
